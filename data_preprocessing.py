...
words=[] #list of unique roots words (patterns) in the data
classes = [] #list of unique tags (topics) in the data
...
# creating function to stem words from unique words /phrases in patterns
...
def bag_of_words_encoding(stem_words, pattern_word_tags_list):
    ...
    for word_tags in pattern_word_tags_list:
        ...
        #Check each word in stem_words list if it matches stemmed_pattern_word
